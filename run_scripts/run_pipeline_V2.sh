...
#mkdir -p /home/clemens/data/RADIOMICS_LOCAL
#cp -r ~/data/cirdata/radiomics/Dataset125_LSS/radiomics_no_autoseg_spacing_111  /home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111

# /home/clemens/data/RADIOMICS_LOCAL/model_dir
...
#####
# health_status="ORD"
# model_dir="/home/clemens/data/RADIOMICS_LOCAL/model_dir/radipop_no_autoseg_spacing_111_${health_status}"
# data_Tr="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_Tr.csv"
# data_iTs="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_iTs.csv"
# data_eTs="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_eTs.csv"


# Step 1: Hyperparameter search ## Already done previously!
#   radipop_training_and_hyperparams_search --data_Tr "${data_Tr}"  \
#                                           --outdir  "${model_dir}" \
#                                           --num_searches 100 \
#                                           --search_scoring_metric neg_root_mean_squared_error  

#   # Step 2: Train models with optimal hyperparameters
#   radipop_train_with_optimal_hp --data_Tr "${data_Tr}" \
#                                  --model_dir "${model_dir}" \
#                                  --outdir "${model_dir}" \
#                                  --hyperparams_source auto
...
# health_status="WFD"
# #model_dir="/home/clemens/data/RADIOMICS_LOCAL/model_dir/radipop_no_autoseg_spacing_111_${health_status}"
# model_dir="/home/clemens/data/RADIOMICS_LOCAL/model_dir/radipop_no_autoseg_spacing_111_${health_status}_original_params"
# data_Tr="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_Tr.csv"
# data_iTs="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_iTs.csv"
# data_eTs="/home/clemens/data/RADIOMICS_LOCAL/radiomics_no_autoseg_spacing_111/df_${health_status}_eTs.csv"
